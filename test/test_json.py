...
class JSONTest(unittest.TestCase):
    def test_yaml_parser(self):
        nvidia_parser = WebMonitor.from_yaml("./test/sources/nvidia_test.yml")
        ...
        self.assertEqual(nvidia_parser.data_type, "api")
    ...
    @patch("data.json_selector.JSONSelector")
    def test_api_parser(self, MockJSONSelector):
        ...
        with patch.object(WebMonitor, "get_data", return_value=test_data):
            api_parser.run()
    ...
    def test_json_selector(self):
        ...
        self.assertEqual(parsed_0[1].price.amount_float, 469.00)
